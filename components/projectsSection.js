  ...
  <>
    <div className={styles.projectContainer}>
      <div className={styles.projectDescription}>
        ...
        <TechStackLabels labels={['JavaScript', 'Redux', 'SASS', 'Gatsby']} />
      </div>
    ...
    <div className={styles.projectContainer}>
      <div className={styles.projectDescription}>
        ...
        <TechStackLabels labels={['React', 'Redux', 'SASS']} />
      </div>
      <div className={styles.projectImages}>
    ...
    <div className={styles.projectContainer}>
      ...
      <div className={styles.projectDescription}>
        ...
        <TechStackLabels labels={['React', 'Redux', 'MaterialUI', 'styled components']} />
      </div>
    </div>
  </>
)
