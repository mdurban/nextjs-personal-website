  ...
  <>
    <div className={styles.jobSection}>
      ...
      <div className={styles.jobContainer}>
        ...
        <div className={styles.jobProjectTechnologies}>Tech Stack: JavaScript, React, Redux, node.js</div>
        ...
        <div className={styles.jobProjectTechnologies}>Tech Stack: JavaScript, React Native, Redux, C#</div>
        ...
        <div className={styles.jobProjectTechnologies}>Tech Stack: Java, Groovy, Ruby, Spring Boot, MongoDB, Bash</div>
      </div>
    </div>
    <div className={styles.jobSection}>
      ...
      <div className={styles.jobContainer}>
        ...
        <div className={styles.jobProjectTechnologies}>Tech Stack: Tcl, Bash</div>
      </div>
    </div>
  </>
)
